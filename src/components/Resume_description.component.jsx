    ...
    return (<div className="card mt-5">
        <div className="card-body">
            <div className="row justify-content-md-center ">
                <h1>Hi!</h1>
                 My name is Juan Diego Mejia, systems engeneer student at the Universidad de Medellin. I am quite self-taught and good at teamwork, I really like to be active and contribute new solutions. I am focused on web development and I am currently learning new technologies of mobile development, I have gained experience with personal and university projects.
            </div>
